...
clc
%%
atl03path = "F:\lunwen\code\h5_data\processed_ATL03_20220823154429_09581606_006_01.h5"; % ATL03 filepath
atl08path = "F:\lunwen\code\h5_data\processed_ATL08_20220823154429_09581606_006_01.h5"; % ATL08 filepath
...
figure;
scatter(filtered_rpc{:,3}, filtered_rpc{:,7}, 10, '.');
xlabel('Along-track Distance');
ylabel(filtered_rpc.Properties.VariableNames{7});

% Saving attribute data
sample=filtered_rpc{:, [3, 7]};
